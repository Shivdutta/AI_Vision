I have calculated Receptive field for the GoogleNet Architecture. Since it is a grouped convolution channels with multiple receptive
fields so have shown the calculations for minimum receptive field  RF_Min( considering 1 * 1 convolutions in each inception block) and
maximum receptive field RF_Max ( considering 5 * 5 convolutions in each inception block)
 ```      
